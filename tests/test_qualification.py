...
def test_rank_teams_uses_points_then_nrr() -> None:
    teams = [
        TeamState("CSK", 10, 6, 4, 0, 12, 0.4),
        TeamState("MI", 10, 6, 4, 0, 12, 0.2),
        TeamState("RCB", 10, 7, 3, 0, 14, -0.1),
    ]
...
def test_qualified_team_ids_returns_top_four() -> None:
    teams = [
        TeamState("A", 0, 0, 0, 0, 10, 1.0),
        TeamState("B", 0, 0, 0, 0, 9, 1.0),
        TeamState("C", 0, 0, 0, 0, 8, 1.0),
        TeamState("D", 0, 0, 0, 0, 7, 1.0),
        TeamState("E", 0, 0, 0, 0, 6, 1.0),
    ]
